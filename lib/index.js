var ScriptTemplate = (function () {
    ...
    ScriptTemplate.prototype.runBlockEach = function (source, data) {
        ...
        function replaceBlockEach(match, name, content) {
            var values = ScriptTemplate.getValue(data, name);
    ...
    ScriptTemplate.prototype.runEach = function (source, data) {
        ...
        function replaceEach(match, eol1, spaceBefore, name, comma, content, eol2) {
            var values = ScriptTemplate.getValue(data, name);
    ...
    ScriptTemplate.getValue = function (data, name) {
        var value = name == "this" ? data : data[name];
